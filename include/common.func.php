...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg = $func;
        $rmsg .= "document.write(\"<br /><div style='width:450px;padding:0px;border:1px solid #eee;'>";
        $rmsg .= "<div style='padding:6px;font-size:11px;';'></div>\");\r\n";
        $rmsg .= "document.write(\"<div style='height:100px;font-size:10pt;background:#fff;box-shadow: 2px 2px 2px #eee;'><br />\");\r\n";
